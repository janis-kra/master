...
In particular, the temporal query feature could render additional aggregation services such as Elasticsearch\footnote{\url{https://www.elastic.co/}} obsolete.
