...
% **************************************************
\newcommand{\thesisTitle}{Implementing a system for passive user feedback using event sourcing}
\newcommand{\thesisName}{Janis Krasemann}
\newcommand{\thesisSubject}{Proposal}
\newcommand{\thesisDate}{November 14, 2017}
...
\newcommand{\thesisUniversityGroup}{Database and Information System}
