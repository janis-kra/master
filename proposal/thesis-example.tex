...
\input{content/chapter-motivation} % INCLUDE: related work
\input{content/chapter-objectives}	% INCLUDE: system
\input{content/chapter-approach} % INCLUDE: concepts
\input{content/chapter-outline} % INCLUDE: outline
\input{content/chapter-workplan} % INCLUDE: conclusion
\cleardoublepage
