...
\todo{Check for consistent tense}
...
Aside from the occasional hint about the location of the button for invoking the channel switcher after it had not been found initially, no problems became apparent during execution.
...
\begin{figure}[h]
		\makebox[\textwidth][c]{
        \includegraphics[width=1.3\textwidth]{gfx/survey.pdf}
        }
        \caption{questionnaire results.}
        \label{figure:evaluation:user:survey-report}
\end{figure}
\todo{update report figure}
...
\begin{figure}[ht]
        ...
        \Cref{figure:evaluation:user:dashboard-clicks-zoom,figure:evaluation:user:dashboard-clicks-zoom-user} show how interaction with the visualization can give additional insights by applying filters to the displayed data.
   		...
   		\makebox[\textwidth][c]{
        \includegraphics[width=1.3\textwidth]{gfx/dashboard-clicks.png}
		}
        \label{figure:evaluation:user:dashboard-clicks}
\end{figure}

The proportion between clicks on the \texttt{/channels/cats} and \texttt{/channels/dogs} URLs seems to indicate that there was more activity and thus more interest in the ``Cats'' channel.
...
\begin{figure}[h]
        \caption{todo.}
        \makebox[\textwidth][c]{
        \includegraphics[width=\textwidth]{gfx/dashboard-clicks-zoom.png}
        }
...
\begin{figure}[h]
        \caption{todo.}
  		\makebox[\textwidth][c]{
        \includegraphics[width=\textwidth]{gfx/dashboard-clicks-zoom-user.png}
        }
...
\citet{Easterbrook2008a} list four factors for validity of empirical work in general: Construct validity, internal validity, external validity, and reliability.\todo{briefly explain what this means}
...
As stated in \cref{sec:intro:objectives}, the total time from creation of an event to the event's contents being displayed in a given Kibana visualization should not be greater than 60 seconds.
...
These factors are construct validity, internal validity, external validity, and reliability.
