...
%This will enable applicants to implement their own innovation systems as described in \ac{CSE}, based on a proven architecture.
%
...
%It is anticipated that this system will profit from the usage of event sourcing, especially for its integration into existing innovation systems, but this has to be further investigated in the thesis.
