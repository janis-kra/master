...
\todo{include goals here, as the requirements relate to this?}
...
\ac{HTTP} may have worse performance than protocols operating on lower levels in the \ac{OSI}\footnote{\url{https://support.microsoft.com/en-us/help/103884/the-osi-model-s-seven-layers-defined-and-functions-explained}} stack, such as \ac{TCP} or \ac{UDP}\todo{acro expansions everywhere :O}, but the advantages in terms of flexibility make \ac{HTTP} the favored solution.
...
\ac{IFAS} was envisioned and developed with the open source version of Kibana.
